  ...
  return (
    <div className="relative flex flex-col lg:flex-row items-center justify-between px-4 py-8 md:px-8 md:py-12 lg:px-16 lg:py-20 overflow-hidden">
      <div className="w-full lg:w-1/2 mb-10 lg:mb-0 lg:pr-10 relative z-10">
        <strong className="text-lg md:text-xl font-bold block mb-4" style={{ color: '#DF6951' }}>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
          ...
          <button className="flex items-center gap-2 text-[#DF6951] font-semibold py-3 px-6 rounded-lg hover:bg-[#DF6951] hover:text-white transition duration-200 text-black">
      ...
      <div className="w-full lg:w-1/2 flex justify-center lg:justify-end relative">
        ...
        <img 
          src={airplane} 
          alt="Airplane" 
          className="absolute w-12 md:w-16 lg:w-20 top-[15%] right-[68%] z-20 animate-float"
        ...
        <img 
          src={airplane} 
          alt="Airplane" 
          className="absolute w-14 md:w-20 lg:w-24 top-[23%] left-[88%] z-20"
          style={{ transform: 'rotate(-5deg)' }}
        />
      </div>
    </div>
